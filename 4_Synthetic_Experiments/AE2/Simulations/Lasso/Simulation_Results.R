...
P_vec = c(12,48,96)
alpha_list <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/AE2/Parameters/alpha_list.RDS")
beta_list <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/AE2/Parameters/beta_list.RDS")
...
results_table_add = function(P_vec, freq, alpha_list, beta_list){
  ...
  # load data
  # 10 trials 
  out1 <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/AE2/Simulations/Lasso/results_ebic/out1.RDS") #p=12
  out2 <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/AE2/Simulations/Lasso/results_ebic/out2.RDS") #p=48
  out3 <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/AE2/Simulations/Lasso/results_ebic/out3.RDS") #p=96
  
  # 50 trials
  out4 <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/AE2/Simulations/Lasso/results_ebic/out4.RDS") #p=12
  out5 <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/AE2/Simulations/Lasso/results_ebic/out5.RDS") #p=48
  out6 <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/AE2/Simulations/Lasso/results_ebic/out6.RDS") #p=96
  ...
  # load data
  # 10 trials 
  out1 <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/AE2/Simulations/Lasso/results_mse/out1.RDS") #p=12
  out2 <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/AE2/Simulations/Lasso/results_mse/out2.RDS") #p=48
  out3 <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/AE2/Simulations/Lasso/results_mse/out3.RDS") #p=96

  # 50 trials
  out4 <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/AE2/Simulations/Lasso/results_mse/out4.RDS") #p=12
  out5 <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/AE2/Simulations/Lasso/results_mse/out5.RDS") #p=48
  out6 <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/AE2/Simulations/Lasso/results_mse/out6.RDS") #p=96
...
# save results ------------------------------------------------------------
setwd("~/Downloads/RSE/4_Synthetic_Experiments/AE2/Simulations/Lasso")
saveRDS(res, "res_AE2_lasso.RDS")
