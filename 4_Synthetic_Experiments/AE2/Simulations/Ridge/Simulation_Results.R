...
results_table_ridge = function(P_vec, freq, alpha_list, beta_list){
  ...
  out1 <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/AE2/Simulations/Ridge/results/out1.RDS") #p=12
  out2 <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/AE2/Simulations/Ridge/results/out2.RDS") #p=48
  out3 <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/AE2/Simulations/Ridge/results/out3.RDS") #p=96
  # 50 trials
  out4 <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/AE2/Simulations/Ridge/results/out4.RDS") #p=12
  out5 <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/AE2/Simulations/Ridge/results/out5.RDS") #p=48
  out6 <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/AE2/Simulations/Ridge/results/out6.RDS") #p=96
...
res_lr
# save results ------------------------------------------------------------
setwd("~/Downloads/RSE/4_Synthetic_Experiments/AE2/Simulations/Ridge")
