...
out1 <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/AE2/Simulations/Periodogram/results/out1.RDS") #p=12
out2 <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/AE2/Simulations/Periodogram/results/out2.RDS") #p=48
...
res = cbind(mse, se)
setwd("~/Downloads/RSE/4_Synthetic_Experiments/AE2/Simulations/Periodogram")
