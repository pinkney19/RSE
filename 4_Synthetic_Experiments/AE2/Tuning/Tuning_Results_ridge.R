...
get_tuned_lambdas_low_rank = function(P_vec, alpha_list, beta_list, freq){
  ...
  res1 <- readRDS("~/luna/RSE/Synthetic_Experiments/Tuning/AE2/ridge/out1.RDS") #12
  res2 <- readRDS("~/luna/RSE/Synthetic_Experiments/Tuning/AE2/ridge/out2.RDS") #48
  res3 <- readRDS("~/luna/RSE/Synthetic_Experiments/Tuning/AE2/ridge/out3.RDS") #96
  ...
  ma_lams
  # 50 trials 
  res4 <- readRDS("~/luna/RSE/Synthetic_Experiments/Tuning/AE2/ridge/out4.RDS") #12
  res5 <- readRDS("~/luna/RSE/Synthetic_Experiments/Tuning/AE2/ridge/out5.RDS") #48
  res6 <- readRDS("~/luna/RSE/Synthetic_Experiments/Tuning/AE2/ridge/out6.RDS") #96
...
setwd("~/Downloads/RSE/4_Synthetic_Experiments/AE2/Tuning")
