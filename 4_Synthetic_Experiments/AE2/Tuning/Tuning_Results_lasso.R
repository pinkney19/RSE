...
get_tuned_lambdas_low_rank_lasso = function(P_vec, alpha_list, beta_list, freq){
  ...
  res1 <- readRDS("~/luna/RSE/Synthetic_Experiments/Tuning/AE2/lasso/out1.RDS") #12
  res2 <- readRDS("~/luna/RSE/Synthetic_Experiments/Tuning/AE2/lasso/out2.RDS") #48
  res3 <- readRDS("~/luna/RSE/Synthetic_Experiments/Tuning/AE2/lasso/out3.RDS") #96
  ...
  ma_lams
  # 50 trials 
  res4 <- readRDS("~/luna/RSE/Synthetic_Experiments/Tuning/AE2/lasso/out4.RDS") #12
  res5 <- readRDS("~/luna/RSE/Synthetic_Experiments/Tuning/AE2/lasso/out5.RDS") #48
  res6 <- readRDS("~/luna/RSE/Synthetic_Experiments/Tuning/AE2/lasso/out6.RDS") #96
