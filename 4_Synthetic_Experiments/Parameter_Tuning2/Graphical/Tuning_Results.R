...
lams_C =  get_tuned_lambdas("C", 3)


setwd("~/Downloads/RSE/4_Synthetic_Experiments/Parameter_Tuning2/Graphical")
saveRDS(lams_A, "lams_A.RDS")
saveRDS(lams_B, "lams_B.RDS")
saveRDS(lams_C,"lams_C.RDS")
