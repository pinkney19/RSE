...
if(k==4){
  ...
  registerDoRNG(seed = 123)
  start2 = Sys.time()
  res <- foreach(k = model2_times, .packages = c("Matrix","phonTools", "QZ", "purrr", "matrixStats", "complexplus", 
                                                 "psych", "pracma", "hawkes")) %dopar%{
...
if(k==7){
  ...
  registerDoRNG(seed = 123)
  start2 = Sys.time()
  res <- foreach(k = model3_times, .packages = c("Matrix","phonTools", "QZ", "purrr", "matrixStats", "complexplus", 
                                                 "psych", "pracma", "hawkes")) %dopar%{
