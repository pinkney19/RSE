...
res1 <- readRDS("~/luna/Paper_Code/Section 4/Reviews/tuning/Ridge/50_trials/res1.RDS")
res2 <- readRDS("~/luna/Paper_Code/Section 4/Reviews/tuning/Ridge/50_trials/res2.RDS")
res3 <- readRDS("~/luna/Paper_Code/Section 4/Reviews/tuning/Ridge/50_trials/res3.RDS")
...
l12 = lam_func_ridge(lambdas, res1, N_samp, gt_12,12, 50)
l48 = lam_func_ridge(lambdas, res2, N_samp, gt_48, 48, 50)
l96 = lam_func_ridge(lambdas, res3, N_samp, gt_96, 96, 50)

ma_lams = rbind(l12, l48, l96)

# model b -----------------------------------------------------------------

res4 <- readRDS("~/luna/Paper_Code/Section 4/Reviews/tuning/Ridge/50_trials/res4.RDS")
res5 <- readRDS("~/luna/Paper_Code/Section 4/Reviews/tuning/Ridge/50_trials/res5.RDS")
res6 <- readRDS("~/luna/Paper_Code/Section 4/Reviews/tuning/Ridge/50_trials/res6.RDS")
...
l12 = lam_func_ridge(lambdas, res4, N_samp, gt_12,12, 50)
l48 = lam_func_ridge(lambdas, res5, N_samp, gt_48, 48, 50)
l96 = lam_func_ridge(lambdas, res6, N_samp, gt_96, 96, 50)
...
res7 <- readRDS("~/luna/Paper_Code/Section 4/Reviews/tuning/Ridge/50_trials/res7.RDS")
res8 <- readRDS("~/luna/Paper_Code/Section 4/Reviews/tuning/Ridge/50_trials/res8.RDS")
res9 <- readRDS("~/luna/Paper_Code/Section 4/Reviews/tuning/Ridge/50_trials/res9.RDS")
...
l12 = lam_func_ridge(lambdas, res7, N_samp, gt_12,12, 50)
l48 = lam_func_ridge(lambdas, res8, N_samp, gt_48, 48, 50)
l96 = lam_func_ridge(lambdas, res9, N_samp, gt_96, 96, 50)
