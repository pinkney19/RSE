...
# Graphical
g_a <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/Simulations2/Graphical/res_a.RDS")
g_b <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/Simulations2/Graphical/res_b.RDS")
g_c <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/Simulations2/Graphical/res_c.RDS")

# Ridge 
r_a <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/Simulations2/Ridge/res_a.RDS")
r_b<- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/Simulations2/Ridge/res_b.RDS")
r_c <- readRDS("~/Downloads/RSE/4_Synthetic_Experiments/Simulations2/Ridge/res_c.RDS")
