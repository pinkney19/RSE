...
results_table_ridge = function(P_vec, model_idx, model_type){
  ...
  # load data
  # 10 trials 
  out1 <- readRDS(paste0("~/Downloads/RSE/4_Synthetic_Experiments/Simulations2/Ridge/Model_", model_type, "/Results/mse/out1.RDS")) #p=12
  out2 <- readRDS(paste0("~/Downloads/RSE/4_Synthetic_Experiments/Simulations2/Ridge/Model_", model_type, "/Results/mse/out2.RDS")) #p=48
  out3 <- readRDS(paste0("~/Downloads/RSE/4_Synthetic_Experiments/Simulations2/Ridge/Model_", model_type, "/Results/mse/out3.RDS")) #p=96
  # 50 trials
  out4 <- readRDS(paste0("~/Downloads/RSE/4_Synthetic_Experiments/Simulations2/Ridge/Model_", model_type, "/Results/mse/out4.RDS")) #p=12
  out5 <- readRDS(paste0("~/Downloads/RSE/4_Synthetic_Experiments/Simulations2/Ridge/Model_", model_type, "/Results/mse/out5.RDS")) #p=48
  out6 <- readRDS(paste0("~/Downloads/RSE/4_Synthetic_Experiments/Simulations2/Ridge/Model_", model_type, "/Results/mse/out6.RDS")) #p=96
...
setwd("~/Downloads/RSE/4_Synthetic_Experiments/Simulations2/Ridge")
