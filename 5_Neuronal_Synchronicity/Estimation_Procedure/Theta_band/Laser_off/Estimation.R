...
res <- foreach(j=lambdas,  .packages = c("Matrix","phonTools", "QZ", "purrr", "matrixStats", "complexplus", 
                                         "psych", "pracma", "hawkes")) %dopar%{
                                           ...
                                           S_hat <- readRDS("~/Downloads/RSE/5_Neuronal_Synchronicity/Estimation_Procedure/Multi_trial_periodogram/Laser_off_estimates/S_OB_0.RDS")
                                           
                                           freqs <- readRDS("~/Downloads/RSE/5_Neuronal_Synchronicity/Estimation_Procedure/Multi_trial_periodogram/freqs.RDS")
                                           
                                           S_hat = S_hat[[2]] # for theta band
                                           f = freqs[2]
...
stopCluster(cl) 
print(end-start)
setwd("~/Downloads/RSE/5_Neuronal_Synchronicity/Estimation_Procedure/Theta_band/Laser_off")
...
res <- foreach(j=lambdas,  .packages = c("Matrix","phonTools", "QZ", "purrr", "matrixStats", "complexplus", 
                                         "psych", "pracma", "hawkes")) %dopar%{
                                           ...
                                           S_hat <- readRDS("~/Downloads/RSE/5_Neuronal_Synchronicity/Estimation_Procedure/Multi_trial_periodogram/Laser_off_estimates/S_OB_10.RDS")
                                           
                                           freqs <- readRDS("~/Downloads/RSE/5_Neuronal_Synchronicity/Estimation_Procedure/Multi_trial_periodogram/freqs.RDS")
                                           
                                           S_hat = S_hat[[2]] # 1 indicates delta band
                                           f = freqs[2]
...
res <- foreach(j=lambdas,  .packages = c("Matrix","phonTools", "QZ", "purrr", "matrixStats", "complexplus", 
                                         "psych", "pracma", "hawkes")) %dopar%{
                                           ...
                                           S_hat <- readRDS("~/Downloads/RSE/5_Neuronal_Synchronicity/Estimation_Procedure/Multi_trial_periodogram/Laser_off_estimates/S_OB_50.RDS")
